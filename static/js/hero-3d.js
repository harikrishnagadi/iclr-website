...
window.addEventListener('DOMContentLoaded', function () {
  ...
  /* ── Config ──────────────────────────────────────────────── */
  var ACCENT   = 0x3b82f6;
  var ACCENT_DIM = 0x1d4ed8;
  var PURPLE   = 0x0f172a;
  var U_MAX    = 1.55;
  var isMobile = W < 768;

  var LEVELS = [
    { u: 0.28, count: isMobile ? 4  : 6,   size: 0.09,  color: 0x93c5fd, label: 'continent' },
    { u: 0.58, count: isMobile ? 8  : 14,  size: 0.06,  color: 0x60a5fa, label: 'country' },
    { u: 0.92, count: isMobile ? 16 : 28,  size: 0.038, color: 0x3b82f6, label: 'region' },
    { u: 1.32, count: isMobile ? 24 : 48,  size: 0.022, color: 0x2563eb, label: 'city' },
  ];
